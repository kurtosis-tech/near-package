...
def add_explorer_frontend_service(
	...
	networks_config_json= """
	{
		...
		"localnet": {
			"explorerLink": "{}",
			"aliases": [],
			"nearWalletProfilePrefix": "${1}/profile"
		}
	}
	""".format(service_url.service_url_to_string_with_override(explorer_backend_public_url,user_requested_backend_ip_address), wallet_public_url)
